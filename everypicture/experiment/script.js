(function(){
    ...
    function onSectionChange(){
        switch(counter){
            case 1: headerImg.innerHTML = "<img src='images/image1.jpg' height='400px' width='300px'>"; break;
            case 2: headerImg.innerHTML = "<img src='images/image2.jpg' height='400px' width='300px'>"; break;
            case 3: headerImg.innerHTML = "<img src='images/image3.jpg' height='300px' width='400px'>"; break;
            case 4: headerImg.innerHTML = "<img src='images/image4.jpg' height='400px' width='300px'>"; break;
