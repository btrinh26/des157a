(function(){
    ...
    const trackLength = document.querySelector("#characters").offsetWidth - 120;
    let p1Position;
    let p2Position; 
    ...
    const oink = new Audio('sounds/oink.mp3');
    ...
    startGame.addEventListener('click', function(){
        ...
        // p1Pig.offsetWidth = `${trackLength}px`;
    ...
    function setUpTurn(){
        instructions.innerHTML = `<p>Roll the dice for the <b>${gameData.players[gameData.index]}</b>`;
    ...
    function throwDice(){
        ...
        instructions.innerHTML = `<p>Roll the dice for the <b>${gameData.players[gameData.index]}</b></p>`;
